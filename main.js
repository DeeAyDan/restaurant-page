...
function contactsContent(){
    ...
    githubPicture.setAttribute('src', 'imgs/github-logo.png');
...
function menuContent(){
    ...
    item1Picture.setAttribute('src', 'imgs/menu-plain.png');
    ...
    item2Picture.setAttribute('src', 'imgs/menu-onigiri.png');
    ...
    item3Picture.setAttribute('src', 'imgs/menu-instant.png');
    ...
    item4Picture.setAttribute('src', 'imgs/menu-sake.png');
...
function pageLoad(){
    ...
    backgroundImage.setAttribute('style','background-image: url("imgs/ramen-stand.gif");background-repeat:no-repeat;height:1350px;width:100vw;position:fixed;background-position: top center;top: -500px;z-index:-1;');

    const element = document.querySelector('#content');
    element.setAttribute('style', 'position:absolute;width:100vw;height: max-content;top:1000px;background-image: url("imgs/background-transition.png");left: 0%;right: 0%;bottom: 0%;');
    ...
    greetingPicture.setAttribute('src', 'imgs/promotion-image.png');
